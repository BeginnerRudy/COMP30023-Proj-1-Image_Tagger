...
EXE = image_tagger
OBJ = main.o handle_http_request.o http_server.o cookie.o response.o player.o
...
handle_http_request.o: handle_http_request.c handle_http_request.h html_pages.h cookie.o response.o player.o
