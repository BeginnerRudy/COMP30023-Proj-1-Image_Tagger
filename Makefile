...
EXE = image_tagger
OBJ = main.o handle_http_request.o http_server.o player.o response.o
...
player.o: player.c player.h
	$(CC) $(CFLAGS) -c player.c html_pages.h

handle_http_request.o: handle_http_request.c handle_http_request.h html_pages.h player.o response.o
